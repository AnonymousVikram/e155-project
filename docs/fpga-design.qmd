...
Overall, the design does a good job of maintaining performance and dilineating the tasks of the FPGA. The output to the monitor was stable and the edge detection performed well!